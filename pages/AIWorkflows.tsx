  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-500">Intelligent triggers to enhance guest experience and streamline operations.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-32 h-32 bg-[#5B8FB1]/5 -mr-16 -mt-16 rounded-full group-hover:scale-110 transition-transform duration-500"></div>
          <div className="relative">
            <div className="w-12 h-12 bg-[#5B8FB1]/10 text-[#5B8FB1] rounded-2xl flex items-center justify-center mb-6">
              <Mail size={24} />
            </div>
            <h3 className="text-xl font-bold text-slate-900 mb-2">Pre-arrival Automation</h3>
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden group">
          ...
          <div className="relative">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Check-out Intelligence</h3>
            <p className="text-slate-500 text-sm mb-6 leading-relaxed">
            ...
            <button 
              ...
              disabled={loading}
              className="w-full py-3 bg-slate-900 text-white rounded-xl font-bold flex items-center justify-center hover:bg-slate-800 transition-colors disabled:opacity-50"
            >
      ...
      {output && (
        <div className="bg-white rounded-3xl border border-[#5B8FB1]/20 shadow-xl overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="bg-[#5B8FB1]/5 px-8 py-4 border-b border-[#5B8FB1]/10 flex items-center justify-between">
            <h4 className="font-bold text-[#5B8FB1]">{output.title}</h4>
            <button onClick={() => setOutput(null)} className="text-[#5B8FB1]/60 hover:text-[#5B8FB1]">
              Dismiss
            </button>
          </div>
          <div className="p-8">
